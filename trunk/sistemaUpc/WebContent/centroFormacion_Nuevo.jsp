...
<p><strong>Mantenimiento de Centro de Formaciones &gt; Nuevo</strong></p>
<form id="form1" name="form1" method="post" action="CentroFormacionInsertarServlet" class="form-horizontal" role="form">
